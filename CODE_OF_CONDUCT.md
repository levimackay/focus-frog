...
reported to the project maintainer. *(No dedicated conduct-reporting email is
set up yet — until one is, use the contact channel described in
[SECURITY.md](SECURITY.md) or open a GitHub issue.)* All complaints will be
...
**1. Correction** — A private, written warning for use of inappropriate
language or other unprofessional behavior, with clarity about why it was
inappropriate.

**2. Warning** — A warning with consequences for continued behavior. No
interaction with the people involved for a specified period, including
